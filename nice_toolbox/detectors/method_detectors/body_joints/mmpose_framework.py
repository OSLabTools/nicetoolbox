...
from ....detectors.configs import config_handler as confh
from ....detectors.method_detectors.base_detector import BaseDetector
from ....detectors.method_detectors.body_joints import utils
...
class MMPose(BaseDetector):
    ...
    def visualization(self, data):
        ...
        """
        logging.info(
            f"VISUALIZING the method detector output of {self.components} and {self.algorithm}."
        )
        ...
        if success:
            ...
            logging.error(
                f"VISUALIZATION {self.components}, {self.algorithm} - FAILURE - Video file was not created"
            )
    ...
    def post_inference(self):
        ...
        for component, result_folder in self.result_folders.items():
            ...
            if len(self.camera_names) < 2:
                ...
                if len(self.camera_names) > 2:
                    logging.warning(
                        f"WARNING - The 2D positions of the joints have been estimated for more than two cameras. \n"
