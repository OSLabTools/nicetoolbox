...
python3.10 -m pip install torchvision==0.16.0 --index-url https://download.pytorch.org/whl/cu118
python3.10 -m pip install -r ./nicetoolbox/detectors/third_party/py_feat/requirements.txt
